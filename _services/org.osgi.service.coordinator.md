...
layout: nested
version: 1.0
description: A coordinator for thread based requests with the possibility to get a callback at the end of a request. 
image: img/org.osgi.service.coordinator.overview.png
---
# Coordinator

![Coordinator Collaboration Diagram](img/org.osgi.service.coordinator.overview.png)
