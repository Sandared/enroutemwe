...
layout: nested
version: 1.0
description: Dispatches OSGi Event Admin events that match a given topic to the front-end using Javascript's Server Sent Events
image: img/osgi.enroute.easse.overview.png
---
# EASSE 

![Event Admin Server Sent Events](img/osgi.enroute.easse.overview.png)
