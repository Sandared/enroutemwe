...
![Eclipse & bnd workspace]({{baseurl}}/documentation/tutorials/quick_start/img/workspaces-layout.png)
...
![Switch Workspace]({{baseurl}}/documentation/tutorials/quick_start/img/qs-switch-0.png)
...
![Start Screen]({{baseurl}}/documentation/tutorials/quick_start/img/qs-switch-1.png)

## Creating the bnd Workspace

To create a new bnd Workspace we use the `New/Other/Bndtools/Bnd OSGi Workspace` menu:

![Select New Workspace Wizard]({{baseurl}}/documentation/tutorials/quick_start/img/workspace-select.png)
...
![bnd workspace location]({{baseurl}}/documentation/tutorials/quick_start/img/location.png)
...
![Select OSGi enRoute Template]({{baseurl}}/documentation/tutorials/quick_start/img/select-enroute.png)
...
![Content list]({{baseurl}}/documentation/tutorials/quick_start/img/empty-bnd-workspace.png)

In our case we just click `Finish` and we're done! Our Eclipse should look like:

![Empty IDE with just cnf]({{baseurl}}/documentation/tutorials/quick_start/img/bnd-empty-workspace.png)
