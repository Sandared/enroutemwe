...
![Create Application Project]({{site.baseurl}}/documentation/tutorials/quick_start/img/app-create-0.png)
...
![Create Application Project]({{site.baseurl}}/documentation/tutorials/quick_start/img/app-create-1.png)
...
![Select the OSGi enRoute template]({{site.baseurl}}/documentation/tutorials/quick_start/img/app-create-2.png)

Select `Next` to go to the Java settings page, which should not change since OSGi enRoute has already set this up.

![Select the OSGi enRoute template]({{site.baseurl}}/documentation/tutorials/quick_start/img/app-create-3.png)
...
![The UpperApplication source code]({{site.baseurl}}/documentation/tutorials/quick_start/img/upper-0.png)
...
![Runtime Requirements]({{site.baseurl}}/documentation/tutorials/quick_start/img/resolve-initial-0.png)

So hit the `Resolve` button. This will open a dialog that shows you what bundles are required in runtime.

![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/resolve-initial-1.png)
...
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/resolve-initial-2.png)
...
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/run-buttons-0.png)
...
![The Application]({{site.baseurl}}/documentation/tutorials/quick_start/img/app-0.png)
...
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/debug-patch-0.png)
...
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/debug-details-0.png)
...
Password:	admin
```
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/debug-xray-0.png)
...
![Run buttons]({{site.baseurl}}/documentation/tutorials/quick_start/img/run-buttons-0.png)
...
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/export-0.png)
...
![Resolved set]({{site.baseurl}}/documentation/tutorials/quick_start/img/export-1.png)
